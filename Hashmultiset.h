#ifndef __MINISTL_HASHMULTISET_H
#define __MINISTL_HASHMULTISET_H
#include"Hashtable.h"
#include"Alloc.h"
...
namespace MiniStl
{
    ...
    class hashmultiset
    {
        ...
        public:
            // constructor
            hashmultiset(const HashFcn& hs, const EqualKey& eq, const size_type n = 100) : t(n, hs, eq) {}
            hashmultiset(const hashmultiset& rhs) : t(rhs.t) {}
            ...
            bool operator==(const hashmultiset& rhs)
            {
                return rhs.t == t;
            }
    ...
    bool operator==(const hashmultiset<Key, HashFcn, EqualKey, Alloc>& lhs, const hashmultiset<Key, HashFcn, EqualKey, Alloc>& rhs)
    {
    ...
    template<class Key, class HashFcn, class EqualKey, class Alloc>
    void swap(hashmultiset<Key, HashFcn, EqualKey, Alloc>& lhs, hashmultiset<Key, HashFcn, EqualKey, Alloc>& rhs)
    {
        lhs.swap(rhs);
    }
}
